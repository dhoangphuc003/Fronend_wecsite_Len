...
const OrderPage = () => {
  ...
  const priceDiscountMemo = useMemo(() => {
    const result = order?.orderItemsSlected?.reduce((total, cur) => {
      ...
      const discountAmount = (cur.price * totalDiscount / 100) * cur.amount; 
  ...
  return (
    <div style={{background: '#f5f5fa', with: '100%', height: '100vh'}}>
      ...
      <h3 style={{marginTop: '10px'}}><span style={{cursor:'pointer'}}  onClick={()=> navigate('/')}>Trang chủ</span> / Giỏ hàng</h3>
        <div style={{ display: 'flex', justifyContent: 'center'}}>
          <WrapperLeft>
            <WrapperStyleHeaderDilivery>
            <div>
              <h4 style={{color:'rgba(0, 0, 0, 0.45)'}}>Phí giao hàng</h4>
              <div>
                <StepComponent 
                  items={itemsDelivery} 
                  current={
                    Number(diliveryPriceMemo) === 10000 ? 1 
                    : Number(diliveryPriceMemo) === 20000 ? 0 
                    : order.orderItemsSlected.length === 0 ? null 
                    : 2
                  }
                />
              </div>
                ...
                return (
                  <WrapperItemOrder key={order?.product}>
                    <div style={{width: '390px', display: 'flex', alignItems: 'center', gap: 4}}> 
                      ...
                      <img src={order?.image} style={{width: '77px', height: '79px', objectFit: 'cover'}} alt='ảnh của sản phẩm'/>
                      <div 
                        style={{
                          width: 260,
                          overflow: 'hidden',
