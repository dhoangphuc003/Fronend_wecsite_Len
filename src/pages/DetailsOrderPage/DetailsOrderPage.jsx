  ...
  return (
   <Loading isLoading={isLoading}>
     <div style={{width: '100%', height: '100vh', background: '#f5f5fa'}}>
      ...
      <h3 style={{marginTop: '10px'}}><span style={{cursor:'pointer'}}  onClick={()=> navigate('/')}>Trang chủ</span> / Chi tiết đơn hàng</h3>
        <WrapperHeaderUser>
          <WrapperInfoUser>
        ...
        <WrapperStyleContent>
          ...
          <WrapperAllPrice style={{borderTop: '1px solid rgb(210,210,210)'}}>
